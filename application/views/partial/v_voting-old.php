    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="rb-box">
                ...
                <p>6. Deeper Dive Required? (optional)</p>
                <div id="rb-8" class="rb <?php echo $voting_values[0]['isDeepDive'] == 1 ? 'rb-tab-active' : ''; ?>">
                    <div class="rb-tab " data-value="<?php echo $voting_values[0]['isDeepDive'] == 1 ? '1' : '0'; ?>">
                        <div class="rb-spot">
                            <span class="rb-txt"><?php echo $voting_values[0]['isDeepDive'] == 1 ? 'Yes' : 'No'; ?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 tarea <?php echo $voting_values[0]['isDeepDive'] == 1 ? '' : 'hidden'; ?> "
                             style="padding-top: 2%">
                            <textarea placeholder="Explain why?" class="form-control">
