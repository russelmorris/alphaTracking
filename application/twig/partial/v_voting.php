<div id="voting-page">
    ...
    <div class="row">
            ...
            <div class="col-sm-12 rb-box">
                ...
                <div class="row slider-holder">
                    <div class="col col-xs-4  col-xs-offset-4 col-md-2 col-md-offset-5">
                        <label id="factor_label_5" class="form-control input-lg text-center">{{ voting_value.factorScore
                            * 10 }}</label>
                    </div>
                </div>
                <div class="row slider-holder">
                ...
                <div class="row text-center voted-ticker-holder">
                    <div class="col col-xs-12 col-sm-4 radio-do-not-like">
                        <label for="factor_id_{{voting_value.factorNo}}_0" class="radio-inline hide-on-xs">Don’t like
                            it</label>
                        <input class="ticker_click radio-voting radio-voting-do-not-like" type="radio"
                               name="factor_{{voting_value.factorNo}}"
                        ...
                        <label for="factor_id_{{voting_value.factorNo}}_0" class="radio-inline show-on-xs">Don’t like
                            it</label>
                    </div>
                    <div class="col col-xs-12 col-sm-4 pull-left">
                        <input class="ticker_click radio-voting radio-voting-pass" type="radio"
                               name="factor_{{voting_value.factorNo}}"
                    ...
                    <div class="col col-xs-12 col-sm-4 radio-like">
                        <input class="ticker_click radio-voting radio-voting-like" type="radio"
                               name="factor_{{voting_value.factorNo}}"
        ...
        <div class="col col-md-2 pull-right">
            <h4>
                Name: <b>{{ sub_user ? sub_user.memberName : user.memberName}}</b></h4>
            <h4>Last modified: <b>{{ dateModified }}</b></h4>
        </div>
    </div>
    <div class="row">
